...
/**
 * ==============================================
 * Collab - Configuration File
 * ==============================================
 *
 * This file contains all configurable settings for the Collab application.
...
module.exports = {
    ...
    media: {
         ...
         * - secret             : Must match NodeMediaServer's config.js (default: 'collabRtmpSecret')
         * - apiSecret          : WebRTC→RTMP API secret (default: 'RtmpApiSecret')
         ...
         * Documentation:
         * --------------
         * - https://docs.collab.com/collab-sfu/rtmp/
         */
        rtmp: {
            ...
            secret: process.env.RTMP_SECRET || 'collabRtmpSecret',
            apiSecret: process.env.RTMP_API_SECRET || 'RtmpApiSecret',
    ...
    security: {
         ...
         */
        jwt: {
            key: process.env.JWT_SECRET || 'sfu_jwt_secret',
        ...
        oidc: {
            ...
            config: {
                ...
                secret: process.env.OIDC_SECRET || 'sfu-oidc-secret',
         ...
         * - users_from_db      : Fetch authorized users from database/API instead of local config (eg., COLLAB WEB)
         *
         * API Integration:
         * ----------------
         ...
         * Documentation:
         * --------------
         * - https://docs.collab.com/collab-sfu/host-protection/
         */
        host: {
            ...
            users_api_secret_key: process.env.USERS_API_SECRET || 'collabweb_default_secret',
            users_api_endpoint: process.env.USERS_API_ENDPOINT || 'http://localhost:9000/api/v1/user/isAuth', // 'https://webrtc.collab.com/api/v1/user/isAuth'
            users_api_room_allowed:
                process.env.USERS_ROOM_ALLOWED_ENDPOINT || 'http://localhost:9000/api/v1/user/isRoomAllowed', // 'https://webrtc.collab.com/api/v1/user/isRoomAllowed'
            users_api_rooms_allowed:
                process.env.USERS_ROOMS_ALLOWED_ENDPOINT || 'http://localhost:9000/api/v1/user/roomsAllowed', // 'https://webrtc.collab.com/api/v1/user/roomsAllowed'
            api_room_exists: process.env.ROOM_EXISTS_ENDPOINT || 'http://localhost:9000/api/v1/room/exists', // 'https://webrtc.collab.com//api/v1/room/exists'
            ...
            presenters: {
                list: process.env.PRESENTERS
                    ...
                    : ['Md. Akib Hossain Omi', 'akibhossainomi2000@gmail.com'],
     ...
     * API Documentation:
     * ------------------
     * - Complete API reference: https://docs.collab.com/collab-sfu/api/
     * - Webhook setup: See integration guides for Slack/Mattermost
     */
    api: {
        keySecret: process.env.API_SECRET || 'collabsfu_default_secret',
        allowed: {
    ...
    integrations: {
         ...
         *                (default: Streaming avatar instructions for Collab)
         */
        videoAI: {
            enabled: process.env.VIDEOAI_ENABLED !== 'false',
            basePath: 'https://api.heygen.com',
            apiKey: process.env.VIDEOAI_API_KEY || '',
            systemLimit: process.env.VIDEOAI_SYSTEM_LIMIT || 'You are a streaming avatar from Collab...',
        },
        ...
        email: {
            ...
            sendTo: process.env.EMAIL_SEND_TO || 'sfu.collab@gmail.com',
        },
            ...
            commands: [
                {
                    ...
                    baseUrl: process.env.DISCORD_BASE_URL || 'https://sfu.collab.com/join/',
                },
            ],
        },
         ...
         *      - Project demo: /collabsfu/webhook/ folder
         */
        webhook: {
    ...
    ui: {
         ...
         * LICENSE REQUIRED:
         * ----------------
         * - https://codecanyon.net/item/collab-sfu-webrtc-realtime-video-conferences/40769970
         */
        brand: {
            /**
             ...
             */
            site: {
                title: process.env.SITE_TITLE || 'Collab, Free Video Calls, Messaging and Screen Sharing',
                icon: process.env.SITE_ICON_PATH || '../images/collab.png',
                appleTouchIcon: process.env.APPLE_TOUCH_ICON_PATH || '../images/collab.png',
            ...
            meta: {
                description:
                    ...
                    'Collab powered by WebRTC and mediasoup for real-time video communications.',
                keywords: process.env.META_KEYWORDS || 'webrtc, video calls, conference, screen sharing, collab, sfu',
            },
    ...
    features: {
        ...
        stats: {
            ...
            src: process.env.STATS_SRC || 'https://stats.collab.com/script.js',
     ...
     * ==============================
     * Core WebRTC components powering Collab
     *
     * Essential Links:
     * ---------------
