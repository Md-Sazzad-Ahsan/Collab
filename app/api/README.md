...
Create a meeting with a `HTTP request` containing the `API_KEY` sent to Collab’s server. The response contains a `meeting` URL that can be `embedded` in your client within an `iframe`.
...
<iframe
    ...
    src="https://sfu.collab.com/join/your_room_name"
...
<iframe
    allow="camera; microphone; display-capture; fullscreen; clipboard-read; clipboard-write; web-share; autoplay"
    src="https://sfu.collab.com/newroom"
    style="height: 100vh; width: 100vw; border: 0px;"
></iframe>
```
